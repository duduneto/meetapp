...
import { congregationsRouter } from "./modules/congregations.js";
...
import { publicSpeakersRouter } from "./modules/publicSpeakers.js";
import { publicSpeakThemesRouter } from "./modules/publicSpeakThemes.js";
...
app.use(congregationsRouter);
app.use(publicSpeakThemesRouter);
app.use(publicSpeakersRouter);
app.use(usersRouter);
